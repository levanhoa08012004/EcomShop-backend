...
public class ReviewController {
    ...
    public ResponseEntity<ReviewResponse> addReview(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(this.reviewService.addReview(comment, rating, createdAt, imageBases, productId, userId));
    }

    @GetMapping
    public ResponseEntity<ResultPaginationDTO> getAllReviewByProductId(
