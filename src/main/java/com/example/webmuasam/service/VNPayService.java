...
import com.example.webmuasam.util.DateUtil;
import com.example.webmuasam.util.constant.Currency;
import com.example.webmuasam.util.constant.Locale;
import com.example.webmuasam.util.constant.Symbol;
...
public class VNPayService implements PaymentService {
    ...
    private String buildPaymentDetail(InitPaymentRequest request) {
        return String.format("Thanh toan don dat hang %s", request.getTxnRef());
    }
    ...
    private String buildInitPaymentUrl(Map<String, String> params) {
        ...
        log.info("🔍 [VNPay] PARAMS BEFORE SIGN: {}", params);
        log.info("🔍 [VNPay] HASH PAYLOAD: {}", hashPayload.toString());
        log.info("🔍 [VNPay] QUERY BEFORE SecureHash: {}", query.toString());
